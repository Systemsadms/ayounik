...
<table width="200" border="0" align="center">
              <tr>
                <td align="center">
                <br>
                <img src="img/contacto.png" width="371" height="88"><br>
                <br></td>
 ...
 <table width="300" border="0" align="center">
  <tr>
    <td width="157"><font face="Tahoma, Geneva, sans-serif"> E-MAIL:</font></td>
  ...
  <tr>
    <td>ISSUE:</td>
    <td><input type="text" class="textbox31" size="30"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>MESSAGE:</td>
    <td><textarea class="textbox6" name="textarea" id="textarea" cols="45" rows="5"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>    
 ...
 <table width="200" border="0" align="center">
   <tr>
     <td><table width="126" border="0" align="center">
       <tr>
         <td align="center"><div id="create">SEND</div></td>
       </tr>
     </table></td>
   </tr>
 </table>
